...
<div class="bg-d-col-12 bg-t-col-12 bg-m-col-12">
	...
	if($post_type == 'bg_team'){
		?>
		<div class="bg-single-avatar-container bg-d-col-6 bg-t-col-6 bg-m-col-12">
			<div class="bg-single-avatar">
				<?php 
				echo get_the_post_thumbnail( get_the_ID(), 'bg-image-medium' );
				//echo wp_get_attachment_image( $gallery, 'bg-image-medium' ) ;?>
			</div>
		</div>
		<div class="bg-single-gallery-container bg-d-col-6 bg-t-col-6 bg-m-col-12">
...
<div class="bg-d-col-12 bg-t-col-12 bg-m-col-12 bg-single-content">
	...
	<div class="bg-meta-container bg-d-col-5 bg-t-col-5 bg-m-col-12 bg-d-offset-1">
		<?php  
		if($post_type == 'bg_team'){
			?>
