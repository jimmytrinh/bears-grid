<?php
/**************************************************************************
 * Create Instagram Shortcode
 **************************************************************************/

if (!class_exists('BG_Instagram_Shortcode')) {
	class BG_Instagram_Shortcode {
		/**
		 * Constructor
		 *
		 * @since 1.0
		...
		*/
		public function __construct() {
			   add_shortcode( 'bg-instagram', array($this, '_build_shortcode_func') );
		}
	...
	$bg_instagram_shortcode = new BG_Instagram_Shortcode();
}
