...
<div class="bg-files-views" data-multiple="<?php echo $multiple ?>" data-max-files="<?php echo $max_files ?>" data-type="images">
	...
	<ul class="bg-files-list">
		...
		if($files != ""){
			...
			echo _get_uploaded_images($files);
		}
		?>
	</ul>
	<div class="bg-add-files">Add Media</div>
